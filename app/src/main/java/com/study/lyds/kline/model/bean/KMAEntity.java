...
public class KMAEntity {
     ...
     * @param n         几日均值
     */
    public KMAEntity(ArrayList<MarketKLineData> kLineBeen, int n) {
     ...
     */
    public KMAEntity(ArrayList<MarketKLineData> kLineBeen, int n, float defult) {
    ...
    private static float getSum(Integer a, Integer b, ArrayList<MarketKLineData> datas) {
        float sum = 0;
        for (int i = a; i <= b; i++) {
    ...
    public static float getLastMA(ArrayList<MarketKLineData> datas, int n) {
