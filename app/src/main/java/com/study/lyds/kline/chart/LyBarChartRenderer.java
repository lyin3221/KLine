 ...
 */
public class LyBarChartRenderer extends BarChartRenderer {

    public LyBarChartRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
...
//    public MyBarChartRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler, KLineData kLineData) {
//        super(chart, animator, viewPortHandler);
