...
public class LyLineChartRenderer extends LineChartRenderer {
    int dotPoint = 2;

    public LyLineChartRenderer(LineDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
